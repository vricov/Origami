    ...
    Backbone.LocalStorage = window.Store = function(name) {
        ...
        try {
            ...
            if(e.name=="NS_ERROR_FILE_CORRUPTED"){
                alert("Sorry, it looks like your browser storage has been corrupted. Please clear your storage by doing to Tools->Clear Resend History->Cookies and set time range to 'Everything'");
                LocalStorage.Clear();
